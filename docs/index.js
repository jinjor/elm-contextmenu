...
var _user$project$ContextMenu$setHoverState = F2(
...
var _user$project$ContextMenu$getItemIndex = function (hover) {
	var _p5 = hover;
...
var _user$project$ContextMenu$ItemIndex = function (a) {
	return {ctor: 'ItemIndex', _0: a};
};
var _user$project$ContextMenu$enterItem = F2(
	function (index, openState) {
		return A2(
			_user$project$ContextMenu$setHoverState,
			_user$project$ContextMenu$ItemIndex(index),
			openState);
	});
...
var _user$project$ContextMenu$leaveItem = function (openState) {
	return A2(_user$project$ContextMenu$setHoverState, _user$project$ContextMenu$Container, openState);
};
var _user$project$ContextMenu$enterContainer = function (openState) {
	return A2(_user$project$ContextMenu$setHoverState, _user$project$ContextMenu$Container, openState);
};
var _user$project$ContextMenu$LeaveContainer = {ctor: 'LeaveContainer'};
var _user$project$ContextMenu$EnterContainer = {ctor: 'EnterContainer'};
var _user$project$ContextMenu$LeaveItem = {ctor: 'LeaveItem'};
...
var _user$project$ContextMenu$subscriptions = function (_p9) {
	var _p10 = _p9;
	var _p12 = _p10._0;
		...
		while (true) {
			...
			switch (_p15.ctor) {
				case 'NoOp':
					return {
						ctor: '_Tuple2',
						_0: _user$project$ContextMenu$ContextMenu(_p16),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'RequestOpen':
					return {
						...
						_1: A2(
							_elm_lang$core$Task$perform,
							A2(_user$project$ContextMenu$Open, _p15._0, _p15._1),
							_elm_lang$window$Window$size)
					};
				case 'Open':
					return {
							...
							_elm_lang$core$Native_Utils.update(
								_p16,
								{
									openState: _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple4', _0: _p15._1, _1: _p15._2, _2: _user$project$ContextMenu$None, _3: _p15._0})
								})),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Close':
					...
					return {
						...
						_0: _user$project$ContextMenu$ContextMenu(
							_elm_lang$core$Native_Utils.update(
								_p16,
								{
									openState: A2(_user$project$ContextMenu$enterItem, _p15._0, _p16.openState)
								})),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'LeaveItem':
					return {
						...
						_0: _user$project$ContextMenu$ContextMenu(
							_elm_lang$core$Native_Utils.update(
								_p16,
								{
									openState: _user$project$ContextMenu$leaveItem(_p16.openState)
								})),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'EnterContainer':
					return {
						...
						_0: _user$project$ContextMenu$ContextMenu(
							_elm_lang$core$Native_Utils.update(
								_p16,
								{
									openState: _user$project$ContextMenu$enterContainer(_p16.openState)
								})),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
					if (_p16.closeOnDeHover) {
						var _v9 = _user$project$ContextMenu$Close,
							...
							_elm_lang$core$Native_Utils.update(
								_p16,
								{
									openState: _user$project$ContextMenu$leaveContainer(_p16.openState)
								}));
						msg = _v9;
						_p13 = _v10;
						continue update;
...
var _user$project$ContextMenu$openIf = F3(
	function (condition, transform, context) {
		return condition ? A3(
			...
			'contextmenu',
			_elm_lang$core$Json_Decode$succeed(
				transform(_user$project$ContextMenu$NoOp)));
	});
var _user$project$ContextMenu$open = F2(
	function (transform, context) {
		return A3(_user$project$ContextMenu$openIf, true, transform, context);
	});
	...
	function (config, transform, hoverIndex, groupIndex, index, _p24) {
			...
			if (_p26.ctor === 'Text') {
				return A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							_user$project$Styles$text(_p28.height)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				return A2(
					...
					A2(
						...
						},
						{
							...
							_0: A2(
								_p27._0._0,
								_p28.disabled ? _user$project$ContextMenu$disabledTextColor : _p27._0._1,
		...
		var events = _p28.disabled ? {ctor: '[]'} : {
			...
			_0: _elm_lang$html$Html_Events$onMouseEnter(
				transform(
					_user$project$ContextMenu$EnterItem(
		...
		var shortCut = A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					A3(_user$project$Styles$shortcut, _user$project$ContextMenu$shortcutTextColor, _p28.height, hovered)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		if (_p31.ctor === 'Just') {
			...
			var groupsView = A2(
				...
				A3(
					...
					config,
					transform,
					_user$project$ContextMenu$getItemIndex(_p31._0._2)),
				groups);
			var _p32 = _user$project$ContextMenu$joinGroupsWithPartition(groupsView);
			if (_p32.ctor === 'Just') {
				var y_ = A4(
				...
				return A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onMouseEnter(
								transform(_user$project$ContextMenu$EnterContainer)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onMouseLeave(
									transform(_user$project$ContextMenu$LeaveContainer)),
								_1: {ctor: '[]'}
							}
						}
					},
					...
					_0: {
						...
						_0: A2(
							...
							A3(
								...
								_jystic$elm_font_awesome$FontAwesome$camera,
					...
					_1: {
						...
						_0: {
							...
							_0: A2(
								...
								A3(
									_user$project$ContextMenu$icon,
									_jystic$elm_font_awesome$FontAwesome$coffee,
								...
								_1: {
									...
									_0: {
										...
										_0: A2(
											...
											A3(
												_user$project$ContextMenu$icon,
												_elm_community$elm_material_icons$Material_Icons_Image$tag_faces,
